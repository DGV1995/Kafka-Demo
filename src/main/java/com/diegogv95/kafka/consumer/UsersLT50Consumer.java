...
@NoArgsConstructor
public class UsersLT50Consumer {
    Logger logger = LoggerFactory.getLogger(UsersLT50Consumer.class.getName());

    public static void main(String[] args) {
        new UsersLT50Consumer().run();
    }
    ...
    public void run() {
        ...
        while(true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                DBCollection col = db.getCollection(AppProperties.MONGO_LT50_USERS_COLLECTION);
    ...
    public KafkaConsumer<String, String> createConsumer() {
        ...
        consumer.subscribe(Arrays.asList(AppProperties.AGE_LESS_THAN_50_TOPIC));
