...
@NoArgsConstructor
public class UsersGT50Consumer {
    Logger logger = LoggerFactory.getLogger(UsersGT50Consumer.class.getName());

    public static void main(String[] args) {
        new UsersGT50Consumer().run();
    }
    ...
    public void run() {
        ...
        while(true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                DBCollection col = db.getCollection(AppProperties.MONGO_GT50_USERS_COLLECTION);
    ...
    public KafkaConsumer<String, String> createConsumer() {
        ...
        consumer.subscribe(Arrays.asList(AppProperties.AGE_GREATHER_THAN_50_TOPIC));
